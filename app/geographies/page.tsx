    ...
    <AppShell>
      <div style={{ padding: '28px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        <div>
          ...
          <h1 style={{ fontSize: '22px', fontWeight: 700, color: '#1a1a2e', margin: 0 }}>Geographies</h1>
          <p style={{ marginTop: '4px', fontSize: '13px', color: '#9a9080' }}>{groups.length} regions across {companies.length} companies.</p>
        </div>
