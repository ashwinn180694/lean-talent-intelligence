    ...
    <AppShell>
      <div className="p-6 space-y-5">
        <div>
          ...
          <h1 className="text-2xl font-bold text-slate-900">Geographies</h1>
          <p className="mt-1 text-sm text-slate-500">{groups.length} regions across {companies.length} companies.</p>
        </div>
