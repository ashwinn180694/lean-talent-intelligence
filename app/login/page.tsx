    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 flex flex-col items-center gap-2">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-brand text-white font-bold text-xl shadow">
            L
          </div>
          <h1 className="text-xl font-semibold text-slate-900">Lean Talent Intelligence</h1>
          <p className="text-sm text-slate-500">Sign in with your @{ALLOWED_DOMAIN} email</p>
        </div>
