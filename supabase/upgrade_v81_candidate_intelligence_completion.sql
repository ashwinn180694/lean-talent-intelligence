-- v8.1 Candidate Intelligence completion: tags, education JSON support, safer candidates view.
create extension if not exists pgcrypto;

alter table public.candidates add column if not exists tags text[] default '{}';
